...
class Pendaftaran_IGD_Model extends CI_Model {
	...
	protected $table_def_pendaftaran = "pendaftaran_igd";
    ...
    public function create($pendaftaran) {
		...
		$data_pendaftaran['tindak_lanjut'] = TLP_PULANG;
		...
		$this->session->set_userdata('register_no_register_igd', FALSE);
		$this->session->set_userdata('register_no_register_igd_id', 0);
	...
	public function incr_no_register() {
		...
		$this->db->where('name', 'no_register_igd');
