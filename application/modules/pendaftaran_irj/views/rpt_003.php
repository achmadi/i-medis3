...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Jumah Kunjungan Per Wilayah</title>
		<style>
		<!--table
		@page
	...
	<body link="blue" vlink="purple">
		...
		<table border="0" cellpadding="0" cellspacing="0" width="620" style="border-collapse: collapse; table-layout: fixed; width: 484pt;">
			...
			<tr height="25" style="height: 18.75pt">
				<td colspan="5" height="25" class="xl91" style="height:18.75pt">JUMLAH KUNJUNGAN PER WILAYAH</td>
			</tr>
			<tr height="20" style="height: 15.0pt">
				<td height="20" colspan="5" style="height: 15.0pt;"></td>
			</tr>
			<tr height="20" style="height: 15.0pt">
				<td colspan="2" height="20" class="xl92" style='border-right:.5pt solid black; height:15.0pt;'>Kabupaten/Kota</td>
			...
			?>
			<tr height="20" style="height:15.0pt">
				<td colspan="2" height="20" class="xl81" style="border-right: .5pt solid black; height: 15.0pt; padding-left: 2px;"><?php echo $row->wilayah; ?></td>
