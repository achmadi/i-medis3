...
<div class="left-sidebar">
		...
		<div class="span12">
			<div class="widget" style="margin-bottom: 10px;">
				<div class="widget-header">
					<div class="title">Filter Kunjungan Per Klinik</div>
				...
				<div class="widget-body">
					<div id="dt_example" class="example_alt_pagination">
						<form class="form-horizontal no-margin" method="post" action="<?php echo site_url('pendaftaran_irj/laporan/'.$laporan); ?>">
							...
							<div class="control-group">
								<label class="control-label" for="report_range1">Kelompok</label>
								<div class="controls">
									<div class="input-append">
										<select>
											<option>Klinik</option>
											<option>Kelompok Pasien</option>
	...
	<div class="row-fluid">
		<div class="span12">
			<div class="widget">
				<div class="widget-header">
					<div class="title">Kunjungan Per Klinik</div>
					<span class="tools"><a class="fs1" aria-hidden="true" data-icon="&#xe090;"></a></span>
				</div>
