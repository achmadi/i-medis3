...
class Pendaftaran_Rad_Model extends CI_Model {
	...
	protected $table_def_pendaftaran = "pendaftaran_rad";
	protected $table_def_pendaftaran_detail = "pendaftaran_rad_detail";
    ...
    public function create($pendaftaran) {
		...
		$this->session->set_userdata('register_no_register_rad', FALSE);
		$this->session->set_userdata('register_no_register_rad_id', 0);
	...
	public function incr_no_register() {
		...
		$this->db->where('name', 'no_register_rad');
