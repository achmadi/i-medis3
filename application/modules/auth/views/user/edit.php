<script type="text/javascript">
    $(document).ready(function() {
		...
		$('#table_dokter').on('click', '.button_tambah_simpan', function() {
			...
			$tr.find('#label_dokter_' + counter).text(dokter);
		...
		$('#table_dokter').on('click', '.button_edit', function() {
			...
			$tr.children('td').eq(0).append('<select id="disp_dokter_' + counter + '"></select>');
									...
									<table id="table_dokter" class="table table-condensed table-striped table-bordered table-hover no-margin">
										<thead>
											<tr>
												...
												<th style="width: 100px;" class="hidden-phone">Actions</th>
											</tr>
										</thead>
										<tbody>
											<?php
											...
											<tr>
												<td>
													...
													<input type="hidden" id="dokter_id_<?php echo $i; ?>" name="dokter_id[]" value="<?php echo $dokter->dokter_id; ?>" />
													<label id="label_dokter"><?php echo $dokter->nama_dokter; ?></label>
												</td>
												<td>
													<button type="button" id="button_edit" class="btn btn-primary btn-mini bottom-margin">Edit</button>
													<button type="button" id="button_hapus" class="btn btn-primary btn-mini bottom-margin">Hapus</button>
												</td>
											</tr>
											<?php
													$i++;
										...
										<tbody>
											<tr id="row_dokter_clone">
												<td>
													...
													<label id="clone_label_dokter"></label>
													<select id="clone_disp_dokter">
													</select>
												</td>
												<td>
													<button type="button" id="button_1" class="btn btn-primary btn-mini bottom-margin">Simpan</button>
													<button type="button" id="button_2" class="btn btn-primary btn-mini bottom-margin">Simpan</button>
												</td>
											</tr>
										</tbody>
									</table>
