	...
	<div class="row-fluid">
		<div class="span12">
			<div class="widget">
				<?php
					if ($is_new) {
						$url = site_url('auth/module/add');
						$title = "Tambah Module";
					}
					else {
						$url = site_url('auth/module/edit/'.$data->id);
						$title = "Edit Module";
					}
				?>
				<form class="form-horizontal no-margin" id="module_form" name="module_form" method="post" action="<?php echo site_url('auth/module/add'); ?>">
							...
							<div class="row-fluid">
								...
								<div class="span6">
									...
									<div class="control-group">
										<label class="control-label" for="no_medrec">Nama Module</label>
										<div class="controls controls-row">
											<?php
												$value = set_value('nama', $data->nama);
											?>
											<input class="span12" type="text" id="nama" name="nama" maxlength="30" placeholder="Nama Module" value="<?php echo $value; ?>">
										</div>
									</div>
									
									<div class="control-group">
										<label class="control-label" for="no_medrec">Jenis Module</label>
										<div class="controls controls-row">
											<?php
