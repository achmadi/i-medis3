	...
	<div class="row-fluid">
		<div class="span12">
			<div class="widget">
				<?php
					if ($is_new) {
						$url = site_url('master/rujukan/add');
						$title = "Tambah Rujukan";
					}
					else {
						$url = site_url('master/rujukan/edit/'.$data->id);
						$title = "Edit Rujukan";
					}
				?>
				<form class="form-horizontal no-margin" id="rujukan_form" name="rujukan_form" method="post" action="<?php echo site_url('master/rujukan/add'); ?>">
							...
							<div class="row-fluid">
								...
								<div class="span6">
									...
									<div class="control-group">
										<label class="control-label" for="no_medrec">Nama Rujukan</label>
										<div class="controls controls-row">
											<?php
												$value = set_value('nama', $data->nama);
											?>
											<input class="span12" type="text" id="nama" name="nama" maxlength="30" placeholder="Nama Rujukan" value="<?php echo $value; ?>">
										</div>
									</div>
									
									<div class="control-group">
										<label class="control-label" for="no_medrec">Jenis Rujukan</label>
										<div class="controls controls-row">
											<?php
