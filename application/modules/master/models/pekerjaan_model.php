...
class Pekerjaan_Model extends CI_Model {
    ...
    public function create($pekerjaan) {
		$data = get_object_vars($pekerjaan);
		unset($data->id);
    ...
    public function update($pekerjaan) {
		$data = get_object_vars($pekerjaan);
		unset($data->id);
        $this->db->where('id', $pekerjaan->id);
