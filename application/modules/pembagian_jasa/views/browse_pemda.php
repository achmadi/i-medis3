<script type="text/javascript">
	$(document).ready(function () {
		...
		var oTable = $('#pemda').dataTable({
			"sPaginationType": "full_numbers",
			"bProcessing"		: true,
			"bServerSide"		: true,
			"sAjaxSource"		: "<?php echo site_url('pembagian_jasa/pembagian_jasa/load_data_pemda?bulan='.$current_bulan.'&tahun='.$current_tahun); ?>",
			"aoColumns"			: [
									  { sWidth: '138px' },
									  { sWidth: '79px' }
								  ]
		...
		<div class="span12">
			<div class="widget">
				<div class="widget-header">
					<div class="title">Insentif Pemda</div>
					<div class="tools pull-right">
						<div class="btn-group">
							<a class="btn btn-success btn-small" href="<?php echo site_url('pembagian_jasa/pembagian_jasa/export_to_excel_rpt_001?bulan='.$current_bulan.'&tahun='.$current_tahun); ?>" data-original-title="">
				...
				<div class="widget-body">
					...
					<div id="dt_example" class="example_alt_pagination">
						<table class="table table-striped table-condensed table-striped table-hover table-bordered pull-left" id="pemda">
							<thead>
								<tr>
									<th>Tanggal/Jam</th>
									<th>Jumlah</th>
							...
							<tfoot>
								<tr>
									...
									<td><strong><?php echo number_format ($jumlah_pemda, 2, ',', '.'); ?></strong></td>
								</tr>
							</tfoot>
						</table>
