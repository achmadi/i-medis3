<script type="text/javascript">
	$(document).ready(function () {
		var oTable = $('#langsung').dataTable({
			"sPaginationType"	: "full_numbers",
			"bProcessing"		: true,
			"bServerSide"		: true,
			"sAjaxSource"		: "<?php echo site_url('pembagian_jasa/pembagian_jasa/load_data_langsung?bulan='.$current_bulan.'&tahun='.$current_tahun); ?>",
			"aoColumns"			: [
									  { sWidth: '138px' },
									  { sWidth: '138px' },
									  { sWidth: '138px' },
			...
			<div class="widget">
				<div class="widget-header">
					...
					<div class="tools pull-right">
						<div class="btn-group">
							<a class="btn btn-success btn-small" href="<?php echo site_url('pembagian_jasa/pembagian_jasa/export_to_excel_rpt_003?bulan='.$current_bulan.'&tahun='.$current_tahun); ?>" data-original-title="">
				...
				<div class="widget-body">
					...
					<div id="dt_example" class="example_alt_pagination">
						<table class="table table-striped table-condensed table-striped table-hover table-bordered pull-left" id="langsung">
							<thead>
								<tr>
									<th>Tanggal/Jam</th>
									<th>No. Rekening</th>
							...
							<tfoot>
								<tr>
									...
									<td style="text-align: right;"><strong><?php echo number_format ($total_langsung, 2, ',', '.'); ?></strong></td>
								</tr>
							</tfoot>
						</table>
